...
function fixturePath(fileName) {
    var fixturesDir = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultFixturesDir;
...
function writeFixture(fileName, text) {
    var fixturesDir = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultFixturesDir;
...
function outputFileName(fileName) {
    var outputDir = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultOutputDir;
...
function cleanOutputDir() {
    var outputDir = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultOutputDir;
...
var Fixture = exports.Fixture = function () {
    function Fixture(text) {
        var ext = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.tsx';
